...
export default function InfoPage() {
  return (
    <>
      <h1>INFO</h1>
      <p className="lead">Pioneering the scene since 2020, the avant-garde powerhouse Over My Body, hailing from Taipei, has relentlessly mesmerized audiences with its unparalleled fusion of sound, visuals, and immersive events. With an unwavering commitment to pushing boundaries, the label has unleashed groundbreaking music from global artists like personalbrand (UK), Capiuz (IT), Lujiachi(TW), WRACK (JP), SABIWA (DE), Max Dahlhaus (DE), and a plethora of
